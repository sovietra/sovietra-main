      ...
      >
        ...
        {showMapToggle && (
          <div className="ml-auto flex items-center gap-1 bg-white/10 rounded-lg p-0.5" onMouseDown={e => e.stopPropagation()}>
            ...
            <button className={`flex items-center gap-1 px-2.5 py-1 rounded-md text-[11px] transition-all ${viewMode==="map"?"bg-white/20 text-white":"text-white/40 hover:text-white/60"}`}
