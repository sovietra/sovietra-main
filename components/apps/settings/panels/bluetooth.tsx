...
const myDevicesDesktop: BluetoothDevice[] = [
  { name: "Shanya's Magic Keyboard", connected: true, battery: 91, type: "keyboard" },
  { name: "Shanya's Magic Trackpad", connected: true, battery: 20, type: "trackpad" },
  { name: "Nothing Headphones", connected: false, type: "headphones" },
  { name: "Shanya's AirPods Max", connected: false, type: "airpods-max" },
  { name: "Shanya's AirPods Pro", connected: false, type: "airpods" },
  { name: "Flipper Reg0l1", connected: false, type: "headphones" },
];

const myDevicesMobile = [
  { name: "Nothing Headphones", connected: true },
  { name: "Shanya's AirPods Max", connected: false },
  { name: "Shanya's AirPods Pro", connected: false },
