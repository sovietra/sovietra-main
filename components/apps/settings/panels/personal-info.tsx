...
const devices: Device[] = [
  { name: "Shanya's MacBook Air", model: "This MacBook Air", type: "macbook" },
  { name: "Shanya's iPhone", model: "iPhone 16 Pro", type: "iphone" },
  { name: "Shanya's iPad", model: "iPad Air", type: "ipad" },
      ...
      <div className="rounded-xl bg-muted/50 overflow-hidden">
        <div className="divide-y divide-border/50">
          <div className="flex items-center justify-between px-4 py-3">
            ...
            <span className="text-xs text-muted-foreground">Shanya Korver</span>
          </div>
          <div className="flex items-center justify-between px-4 py-3">
            <span className="text-xs">Education</span>
            <span className="text-xs text-muted-foreground">Het Vista College</span>
          </div>
          <div className="flex items-center justify-between px-4 py-3">
            <span className="text-xs">Work</span>
            <span className="text-xs text-muted-foreground">Intern at Collabotics</span>
          </div>
        </div>
      </div>
