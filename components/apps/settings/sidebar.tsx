...
const appleAccountKeywords = ["shanya", "korver", "apple", "account", "personal", "information", "name", "birthday"];
                ...
                {showAppleAccount && (
                  ...
                  >
                    ...
                    <div className="text-left flex-1">
                      <div className="font-semibold text-lg">Shanya Korver</div>
                ...
                <div className="py-2">
                  ...
                  >
                    ...
                    <div className="text-left">
                      <div className="font-medium text-xs">Shanya Korver</div>
